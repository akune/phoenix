...
//	      },
	...
	public static byte[] digest(byte[] input) {
		JsCryptoSha256 instance = newInstance();
		instance.update((JsArrayInteger) JsArrayUtils.toJsArrayNumber(input).cast());
		JsArrayInteger result = instance.digest();
		GWT.log(result.toString());
		return JsArrayUtils.toByteArray((JsArrayNumber) result.cast());
	}
